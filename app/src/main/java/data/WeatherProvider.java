...
public class WeatherProvider extends ContentProvider {
  ...
  private Cursor getWeatherByLocationSettingAndDate(Uri uri, String[] projection, String sortOrder){
	...
	return sWeatherByLocationSettingQueryBuilder
	  .query(mOpenHelper.getReadableDatabase(), projection, sLocationSettingAndDaySelection, new String[]{locationSetting, date}, null, null,
			 sortOrder);
  }
	...
	switch(sUriMatcher.match(uri)){
	  ...
	  case LOCATION_ID:{
		retCursor = mOpenHelper.getReadableDatabase().query(WeatherContract.LocationEntry.TABLE_NAME, projection,
															WeatherContract.LocationEntry._ID + " = '" + android.content.ContentUris
															  .parseId(uri) + "'", null, null, null, sortOrder);
		break;
	  }
	  // "location"
	  case LOCATION:{
