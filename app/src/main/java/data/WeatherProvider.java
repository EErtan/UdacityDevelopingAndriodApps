...
public class WeatherProvider extends ContentProvider {
   ...
   private static final android.database.sqlite.SQLiteQueryBuilder sWeatherByLocationSettingQueryBuilder;

   static{
	  sWeatherByLocationSettingQueryBuilder = new android.database.sqlite.SQLiteQueryBuilder();
   ...
   private Cursor getWeatherByLocationSettingAndDate(Uri uri, String[] projection, String sortOrder){
	  ...
	  return sWeatherByLocationSettingQueryBuilder.query(mOpenHelper.getReadableDatabase(), projection, sLocationSettingAndDaySelection, new String[]{locationSetting, date}, null, null, sortOrder);
   }
   ...
   public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder){
	  ...
	  switch(sUriMatcher.match(uri)){
		 ...
		 // "location/*"
		 case LOCATION_ID:{
			retCursor = mOpenHelper.getReadableDatabase().query(WeatherContract.LocationEntry.TABLE_NAME, projection, WeatherContract.LocationEntry._ID + " = '" + android.content.ContentUris.parseId(uri) + "'", null, null, null, sortOrder);
			break;
		 }
		 // "location"
		 case LOCATION:{
   ...
   public Uri insert(Uri uri, ContentValues values){
	  final android.database.sqlite.SQLiteDatabase db = mOpenHelper.getWritableDatabase();
	  final int match = sUriMatcher.match(uri);
	  Uri returnUri;
