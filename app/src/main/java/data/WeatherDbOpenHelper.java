...
public class WeatherDbOpenHelper extends android.database.sqlite.SQLiteOpenHelper {
   ...
   public WeatherDbOpenHelper(android.content.Context inContext){
   ...
   public void onCreate(android.database.sqlite.SQLiteDatabase inSQLiteDatabase){
	  ...
	  inSQLiteDatabase.execSQL(SQL_CREATE_LOCATION_TABLE);
	  inSQLiteDatabase.execSQL(SQL_CREATE_WEATHER_TABLE);

   }

   @Override
   public void onUpgrade(android.database.sqlite.SQLiteDatabase inSQLiteDatabase, int oldVersion, int newVersion){
	  ...
	  inSQLiteDatabase.execSQL("DROP TABLE IF EXISTS " + LocationEntry.TABLE_NAME);
	  inSQLiteDatabase.execSQL("DROP TABLE IF EXISTS " + WeatherEntry.TABLE_NAME);
	  onCreate(inSQLiteDatabase);
