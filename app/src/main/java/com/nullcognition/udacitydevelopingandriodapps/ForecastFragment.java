...
public class ForecastFragment extends Fragment {
   ...
   private void updateWeather(){
	  ...
	  String postalCodeKeyExampleText = getActivity().getResources().getString(com.nullcognition.udacitydevelopingandriodapps.R.string.pref_default_edittext_pref);
	  String postalCode = android.preference.PreferenceManager.getDefaultSharedPreferences(getActivity().getApplicationContext()).getString(postalCodeKeyExampleText, "n2n1w4");
