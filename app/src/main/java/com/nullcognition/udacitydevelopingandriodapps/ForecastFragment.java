	...
	public boolean onOptionsItemSelected(android.view.MenuItem inMenuItem){
		switch(inMenuItem.getItemId()){
			case com.nullcognition.udacitydevelopingandriodapps.R.id.action_refresh:
				FetchWeatherTask weatherTask = new com.nullcognition.udacitydevelopingandriodapps.ForecastFragment.FetchWeatherTask();
...
//		listView.setAdapter(arrayAdapter);
	...
	class FetchWeatherTask extends android.os.AsyncTask<String, Void, String[]> {
		...
		protected void onPostExecute(String[] result){
			...
			if(result != null){
				android.widget.ArrayAdapter<String> arrayAdapter = new android.widget.ArrayAdapter<String>(getActivity(), com.nullcognition.udacitydevelopingandriodapps.R.layout.list_item_forcast, com.nullcognition.udacitydevelopingandriodapps.R.id.list_item_forecast_textview);
				arrayAdapter.clear();
				arrayAdapter.addAll(result);

				android.widget.ListView listView = (android.widget.ListView)getActivity().findViewById(com.nullcognition.udacitydevelopingandriodapps.R.id.listview_forecast);
				listView.setAdapter(arrayAdapter);
