...
public class TestProvider extends android.test.AndroidTestCase { // function names must start with test
   ...
   public void deleteAllRecords(){
	  ...
	  android.database.Cursor cursor = mContext.getContentResolver().query(WeatherEntry.CONTENT_URI, null, null, null, null);
   ...
   public void testInsertReadProvider(){
	  ...
	  android.content.ContentValues testValues = TestDb.createNorthPoleLocationValues();

	  android.net.Uri locationUri = mContext.getContentResolver().insert(LocationEntry.CONTENT_URI, testValues);
	  long locationRowId = android.content.ContentUris.parseId(locationUri);
	  ...
	  android.database.Cursor cursor = mContext.getContentResolver().query(LocationEntry.CONTENT_URI, null, // leaving "columns" null just returns all the columns.
	  ...
	  cursor = mContext.getContentResolver().query(LocationEntry.buildLocationUri(locationRowId), null, // leaving "columns" null just returns all the columns.
												   null, // cols for "where" clause
												   null, // values for "where" clause
												   null  // sort order
												  );
	  ...
	  android.content.ContentValues weatherValues = TestDb.createWeatherValues(locationRowId);

	  android.net.Uri weatherInsertUri = mContext.getContentResolver().insert(WeatherEntry.CONTENT_URI, weatherValues);
	  assertTrue(weatherInsertUri != null);

	  // A cursor is your primary interface to the query results.
	  android.database.Cursor weatherCursor = mContext.getContentResolver().query(WeatherEntry.CONTENT_URI,  // Table to Query
	  ...
	  weatherCursor = mContext.getContentResolver().query(WeatherEntry.buildWeatherLocation(TestDb.TEST_LOCATION), null, // leaving "columns" null just returns all the columns.
														  null, // cols for "where" clause
														  null, // values for "where" clause
														  null  // sort order
														 );
	  ...
	  weatherCursor = mContext.getContentResolver().query(WeatherEntry.buildWeatherLocationWithStartDate(TestDb.TEST_LOCATION, TestDb.TEST_DATE), null, // leaving "columns" null just returns all the columns.
														  null, // cols for "where" clause
														  null, // values for "where" clause
														  null  // sort order
														 );
   ...
   public void testUpdateLocation(){
	  ...
	  android.content.ContentValues values = TestDb.createNorthPoleLocationValues();

	  android.net.Uri locationUri = mContext.getContentResolver().
	  ...
	  android.content.ContentValues updatedValues = new android.content.ContentValues(values);
	  ...
	  // A cursor is your primary interface to the query results.
	  android.database.Cursor cursor = mContext.getContentResolver().query(LocationEntry.buildLocationUri(locationRowId), null, null, // Columns for the "where" clause
   ...
   void addAllContentValues(android.content.ContentValues destination, android.content.ContentValues source){
   ...
   static android.content.ContentValues createKalamazooWeatherValues(long locationRowId){
   ...
   static android.content.ContentValues createKalamazooLocationValues(){
	  // Create a new map of values, where column names are the keys
   ...
   public void insertKalamazooData(){
	  android.content.ContentValues kalamazooLocationValues = createKalamazooLocationValues();
	  android.net.Uri locationInsertUri = mContext.getContentResolver().insert(LocationEntry.CONTENT_URI, kalamazooLocationValues);
	  assertTrue(locationInsertUri != null);

	  locationRowId = android.content.ContentUris.parseId(locationInsertUri);

	  android.content.ContentValues kalamazooWeatherValues = createKalamazooWeatherValues(locationRowId);
	  android.net.Uri weatherInsertUri = mContext.getContentResolver().insert(WeatherEntry.CONTENT_URI, kalamazooWeatherValues);
	  assertTrue(weatherInsertUri != null);
   }
   ...
   public void testUpdateAndReadWeather(){
	  ...
	  android.content.ContentValues kalamazooUpdate = new android.content.ContentValues();
	  ...
	  // A cursor is your primary interface to the query results.
	  android.database.Cursor weatherCursor = mContext.getContentResolver().query(WeatherEntry.CONTENT_URI, null, null, null, null);
   ...
   public void testRemoveHumidityAndReadWeather(){
	  ...
	  mContext.getContentResolver().delete(WeatherEntry.CONTENT_URI, WeatherEntry.COLUMN_HUMIDITY + " = " + locationRowId, null);
